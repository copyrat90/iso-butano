...
constexpr bn::utf8_character fixed_8x16_sprite_font_utf8_characters[] = {"Á", "É", "Í", "Ó", "Ú", "Ü", "Ñ", "á",
                                                                         "é", "í", "ó", "ú", "ü", "ñ", "¡", "¿"};
...
constexpr bn::sprite_font fixed_8x16_sprite_font(bn::sprite_items::common_fixed_8x16_font,
